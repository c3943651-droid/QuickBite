...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<IValidator<AdjustStockRequest>, AdjustStockValidator>();
        services.AddScoped<IValidator<UpdateOrderStatusRequest>, UpdateOrderStatusValidator>();
        services.AddScoped<IValidator<AssignDeliveryRequest>, AssignDeliveryValidator>();
        services.AddScoped<IValidator<CancelOrderRequest>, CancelOrderValidator>();
        services.AddScoped<IValidator<UpdateConfigRequest>, UpdateConfigValidator>();
